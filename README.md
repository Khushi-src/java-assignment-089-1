...
**Usage**
- Upon launch, select an option from the menu:
- Create Account
- Deposit
- Withdraw
- Check Balance
- Exit
- Enter the corresponding number and follow on-screen prompts.
- Actions apply to an in-memory Account instance; data is not persisted.

**WORKING SCREENSHOTS**
- <img width="453" height="240" alt="image" src="https://github.com/user-attachments/assets/db9371ee-c75b-4085-9422-4620131f64be" />
- <img width="613" height="216" alt="image" src="https://github.com/user-attachments/assets/c3db5d0a-6d9d-4ef3-843b-5dc38bd7637e" />
- <img width="572" height="392" alt="image" src="https://github.com/user-attachments/assets/fe3d9a95-7a91-457d-86f9-15735db9441e" />
- <img width="595" height="367" alt="image" src="https://github.com/user-attachments/assets/f5cd9995-bb51-49ad-8d7d-83331cafdd85" />
